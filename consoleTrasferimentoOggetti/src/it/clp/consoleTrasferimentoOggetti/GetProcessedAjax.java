 ...
 */
public class GetProcessedAjax extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetProcessedAjax() {
        super();
			...
			if ( result != null)
			{
				...
				while (result.next())
				{
					...
					if ( result.getRow() < iNumRecords )
					{
						...
						out.println("\"" + UtilityFunction.escapeStringJSON("<a href=\"viewDetailRequest.jsp?reqID=" +  result.getString("reqID") + "\" ><h1  class=\"detail_request\">Effettua deploy</h1></a>") + "\"\n],");
					}
